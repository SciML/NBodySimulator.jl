...
const ρ = 216 # kg/m^3
const mO = 15.999 * 1.6747 * 1.0e-27 # kg
const mH = 1.00794 * 1.6747 * 1.0e-27 #
const mH2O = mO + 2 * mH
const N = 216 #floor(Int, ρ * L^3 / m)
const L = (mH2O * N / ρ)^(1 / 3) #10.229σ
const R = 9.0e-10 # 3*σOO
const Rel = 0.49 * L
const v_dev = sqrt(kb * T / mH2O)
const τ = 0.5e-15 # σ/v
const t1 = 0τ
const t2 = 6000τ
const k_bond = 1059.162 * 4184 * 1.0e20 / Na # J/m^2
const k_angle = 75.9 * 4184 / Na # J/rad^2
